  ...
  return (
    <div className="main-content">
          ...
          <div className="filters-container" id="imgs-buttons-filters">
            ...
            >
              ...
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <line x1="11" y1="1.5" x2="11" y2="8.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="11" y1="13.5" x2="11" y2="20.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="1.5" y1="11" x2="8.5" y2="11" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="13.5" y1="11" x2="20.5" y2="11" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="3.4" y1="3.4" x2="8.3" y2="8.3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="13.7" y1="13.7" x2="18.6" y2="18.6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="18.6" y1="3.4" x2="13.7" y2="8.3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <line x1="8.3" y1="13.7" x2="3.4" y2="18.6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
              </svg>
            </button>
          </div>
      ...
      <footer className="footer">
        ...
        <p>
          Created by{' '}
          <a href="https://www.linkedin.com/in/krystalpothilat" target="_blank" rel="noopener noreferrer" id="linked-in-tag">
            Krystal Pothilat
          </a>
        </p>
      </footer>
